...
- Editör headless paketinin variable/condition/native-state ve preview-coalescing,
  ...
  `--headless-test` davranışı ile Test 1–28 çıktısı korunur (Test 3/4/5/7/9/12/14/15/16/
