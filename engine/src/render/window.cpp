...
void Window::initFontRenderer() {
    ...
    // W8-d(4): uc-kademe cozumleme window_font_resolve TU'suna tasindi;
    // sira (VFS-once/sistem-sonra) ve negatif-kume davranisi korunur.
    resolveWindowFont(*m_fontRenderer, vfs());
}
